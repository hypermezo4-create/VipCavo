  ...
  static ThemeData light(DeadzonThemeController theme) {
    ...
    return base.copyWith(
      ...
      textTheme: GoogleFonts.interTextTheme(base.textTheme).copyWith(
        ...
        titleMedium: GoogleFonts.inter(fontSize: DesignTokens.rowTitle, fontWeight: FontWeight.w650),
        ...
        labelLarge: GoogleFonts.inter(fontSize: DesignTokens.buttonText, fontWeight: FontWeight.w650),
  ...
  static ThemeData dark(DeadzonThemeController theme) {
    ...
    return base.copyWith(
      ...
      textTheme: GoogleFonts.interTextTheme(base.textTheme).apply(bodyColor: Colors.white, displayColor: Colors.white).copyWith(
        ...
        titleMedium: GoogleFonts.inter(fontSize: DesignTokens.rowTitle, fontWeight: FontWeight.w650, color: Colors.white),
        ...
        labelLarge: GoogleFonts.inter(fontSize: DesignTokens.buttonText, fontWeight: FontWeight.w650, color: Colors.white),
