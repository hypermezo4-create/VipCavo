...
class MountDefaults {
  ...
  static const List<MountSelectableApp> mockSelectableApps = <MountSelectableApp>[
    MountSelectableApp(name: 'Settings', packageName: 'com.android.settings', category: 'Core System', installed: true),
    MountSelectableApp(name: 'System UI', packageName: 'com.android.systemui', category: 'Core System', installed: true),
    MountSelectableApp(name: 'Theme Manager', packageName: 'com.android.thememanager', category: 'Xiaomi / HyperOS', installed: true),
    MountSelectableApp(name: 'Security Center', packageName: 'com.miui.securitycenter', category: 'Xiaomi / HyperOS', installed: true),
    MountSelectableApp(name: 'MI Home', packageName: 'com.miui.home', category: 'Launcher', installed: true),
    MountSelectableApp(name: 'Chrome', packageName: 'com.android.chrome', category: 'User Apps', installed: true),
    MountSelectableApp(name: 'Telegram', packageName: 'org.telegram.messenger', category: 'User Apps', installed: true),
    MountSelectableApp(name: 'HyperOS AI', packageName: 'com.miui.superassistant', category: 'Xiaomi / HyperOS', installed: false),
    MountSelectableApp(name: 'Media Editor', packageName: 'com.miui.mediaeditor', category: 'Missing', installed: false),
  ];
