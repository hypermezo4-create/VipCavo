...
class MountDefaults {
  ...
  static const List<MountPalette> paletteLibrary = <MountPalette>[
    ...
    MountPalette(id: 'ocean', name: 'Ocean', primary: Color(0xFF63DBE6), secondary: Color(0xFF9AF0F7), tertiary: Color(0xFF2EABB9), backgroundTint: Color(0x22214A4F), accent: Color(0xFF7BE7F0), previewGradient: <Color>[Color(0xFF63DBE6), Color(0xFF9AF0F7)]),
    MountPalette(id: 'violet', name: 'Violet', primary: Color(0xFF7F65D1), secondary: Color(0xFFA691E6), tertiary: Color(0xFF5A3DB6), backgroundTint: Color(0x222D2450), accent: Color(0xFF927DDB), previewGradient: <Color>[Color(0xFF7F65D1), Color(0xFFA691E6)]),
    MountPalette(id: 'carbon', name: 'Carbon', primary: Color(0xFF9BA2AF), secondary: Color(0xFFC5CCD8), tertiary: Color(0xFF707887), backgroundTint: Color(0x222D323A), accent: Color(0xFFAFB5C2), previewGradient: <Color>[Color(0xFF707887), Color(0xFFC5CCD8)]),
    MountPalette(id: 'midnight', name: 'Midnight', primary: Color(0xFF709BFF), secondary: Color(0xFFA5BEFF), tertiary: Color(0xFF456ECC), backgroundTint: Color(0x22273459), accent: Color(0xFF8EAEFF), previewGradient: <Color>[Color(0xFF709BFF), Color(0xFFA5BEFF)]),
    MountPalette(id: 'slate', name: 'Slate', primary: Color(0xFF7B93A8), secondary: Color(0xFF95AEC2), tertiary: Color(0xFF56687A), backgroundTint: Color(0x22212A34), accent: Color(0xFFA9C2D8), previewGradient: <Color>[Color(0xFF7B93A8), Color(0xFF56687A)]),
    MountPalette(id: 'deep_blue', name: 'Deep Blue', primary: Color(0xFF8CA6FF), secondary: Color(0xFFA8B8F8), tertiary: Color(0xFF86E1D4), backgroundTint: Color(0x2228354D), accent: Color(0xFFB7C6FF), previewGradient: <Color>[Color(0xFF8CA6FF), Color(0xFF86E1D4)]),
    MountPalette(id: 'dark_teal', name: 'Dark Teal', primary: Color(0xFF7AC5B3), secondary: Color(0xFF9CE2FF), tertiary: Color(0xFF5F9A8D), backgroundTint: Color(0x22284345), accent: Color(0xFF9ED8C6), previewGradient: <Color>[Color(0xFF7AC5B3), Color(0xFF9CE2FF)]),
  ];
