...
.method private getButtonName(Z)Ljava/lang/String;
    .registers 7

    if-eqz p1, :cond_21

    const-string v1, "color_ok"

    :goto_4
    invoke-virtual {p0}, Landroidx/preference/MiuiColorPicker/ColorPickerPanelView;->getResources()Landroid/content/res/Resources;
...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    iget v6, p0, Landroidx/preference/MiuiColorPicker/ColorPickerPanelView;->mBorderColor:I
    ...
    iget-object v6, p0, Landroidx/preference/MiuiColorPicker/ColorPickerPanelView;->mBorderPaint:Landroid/graphics/Paint;

    invoke-virtual {p1, v4, v7, v7, v6}, Landroid/graphics/Canvas;->drawRoundRect(Landroid/graphics/RectF;FFLandroid/graphics/Paint;)V
    ...
    :goto_25
    invoke-direct {p0, v4}, Landroidx/preference/MiuiColorPicker/ColorPickerPanelView;->getButtonName(Z)Ljava/lang/String;

    move-result-object v0

    iget-object v4, p0, Landroidx/preference/MiuiColorPicker/ColorPickerPanelView;->mColorPaint:Landroid/graphics/Paint;

    iget v6, p0, Landroidx/preference/MiuiColorPicker/ColorPickerPanelView;->mColor:I

    invoke-virtual {v4, v6}, Landroid/graphics/Paint;->setColor(I)V

    iget-object v4, p0, Landroidx/preference/MiuiColorPicker/ColorPickerPanelView;->mColorPaint:Landroid/graphics/Paint;

    invoke-virtual {p1, v1, v7, v7, v4}, Landroid/graphics/Canvas;->drawRoundRect(Landroid/graphics/RectF;FFLandroid/graphics/Paint;)V
