...
.class public Landroidx/preference/MiuiPreferenceHelper;
.super Ljava/lang/Object;
.source "MiuiPreferenceHelper.java"
...
# instance fields
.field private final mAttr:Landroid/util/AttributeSet;
...
.method static constructor <clinit>()V
    ...
    const-class v0, Landroidx/preference/MiuiPreferenceHelper;

    invoke-virtual {v0}, Ljava/lang/Class;->getSimpleName()Ljava/lang/String;

    move-result-object v0

    sput-object v0, Landroidx/preference/MiuiPreferenceHelper;->TAG:Ljava/lang/String;
...
.method constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object v0, p0, Landroidx/preference/MiuiPreferenceHelper;->mIntent:Ljava/lang/String;

    iput-object v0, p0, Landroidx/preference/MiuiPreferenceHelper;->mKey:Ljava/lang/String;

    invoke-virtual {p1}, Landroid/content/Context;->getApplicationContext()Landroid/content/Context;

    move-result-object v0

    iput-object v0, p0, Landroidx/preference/MiuiPreferenceHelper;->mContext:Landroid/content/Context;

    iput-object p2, p0, Landroidx/preference/MiuiPreferenceHelper;->mAttr:Landroid/util/AttributeSet;

    invoke-direct {p0}, Landroidx/preference/MiuiPreferenceHelper;->init()V
...
.method private init()V
    ...
    iget-object v0, p0, Landroidx/preference/MiuiPreferenceHelper;->mAttr:Landroid/util/AttributeSet;

    if-eqz v0, :cond_14

    const-string v0, "key"

    invoke-virtual {p0, v0}, Landroidx/preference/MiuiPreferenceHelper;->getAttributeAndroidValue(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p0, v0}, Landroidx/preference/MiuiPreferenceHelper;->getAttributeValue(Ljava/lang/String;)Ljava/lang/String;
...
.method getBool()Z
    ...
    iget-object v0, p0, Landroidx/preference/MiuiPreferenceHelper;->mKey:Ljava/lang/String;
...
.method public isValidateKey()Z
    ...
    iget-object v0, p0, Landroidx/preference/MiuiPreferenceHelper;->mContext:Landroid/content/Context;
    ...
    :try_start_7
    iget-object v2, p0, Landroidx/preference/MiuiPreferenceHelper;->mKey:Ljava/lang/String;
    ...
    :try_start_e
    iget-object v3, p0, Landroidx/preference/MiuiPreferenceHelper;->mKey:Ljava/lang/String;
    ...
    :try_start_15
    iget-object v4, p0, Landroidx/preference/MiuiPreferenceHelper;->mKey:Ljava/lang/String;
    ...
    iget-object v5, p0, Landroidx/preference/MiuiPreferenceHelper;->mKey:Ljava/lang/String;
...
.method public sendIntent()V
    ...
    iget-object v0, p0, Landroidx/preference/MiuiPreferenceHelper;->mIntent:Ljava/lang/String;
    ...
    iget-object v2, p0, Landroidx/preference/MiuiPreferenceHelper;->mIntent:Ljava/lang/String;
