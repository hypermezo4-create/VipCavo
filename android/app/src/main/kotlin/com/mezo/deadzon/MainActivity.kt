...
class MainActivity : FlutterActivity() {
        ...
        MethodChannel(flutterEngine.dartExecutor.binaryMessenger, channelName)
            .setMethodCallHandler { call, result ->
                ...
                when (call.method) {
                    ...
                    "canWriteSystemSettings" -> result.success(canWriteSystemSettings())
                    "openWriteSettingsPanel" -> result.success(openWriteSettingsPanel())
    ...
    private fun openWriteSettingsPanel(): Boolean {
        return try {
