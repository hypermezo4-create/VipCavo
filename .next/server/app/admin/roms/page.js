...
/* harmony export */   "default": () => (/* binding */ AdminRoms)
/* harmony export */ });
...
function AdminRoms() {
  ...
  async function load() {
    const {
      data
    } = await _lib_supabaseClient__WEBPACK_IMPORTED_MODULE_2__/* .supabase.from */ .O.from("roms").select("id,device_id,name,version,release_date,changelogs,installation,download_url").order("created_at", {
      ascending: false
    });
    setItems(data ?? []);
    const {
      data: devs
    } = await _lib_supabaseClient__WEBPACK_IMPORTED_MODULE_2__/* .supabase.from */ .O.from("devices").select("id,name,codename").order("name", {
      ascending: true
    });
    setDevices(devs ?? []);
  }
  ...
  async function save() {
    ...
    if (editing) await _lib_supabaseClient__WEBPACK_IMPORTED_MODULE_2__/* .supabase.from */ .O.from("roms").update(payload).eq("id", editing.id);else await _lib_supabaseClient__WEBPACK_IMPORTED_MODULE_2__/* .supabase.from */ .O.from("roms").insert(payload);
    setEditing(null);
    await load();
  }
  ...
  async function del(id) {
    ...
    await _lib_supabaseClient__WEBPACK_IMPORTED_MODULE_2__/* .supabase.from */ .O.from("roms").delete().eq("id", id);
    await load();
  }
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsxs)("div", {
    children: [/*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx("h1", {
      ...
      children: [/*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx("strong", {
        children: editing ? "Edit ROM" : "Add ROM"
      }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsxs)("select", {
        value: deviceId,
        onChange: e => setDeviceId(e.target.value),
        children: [/*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx("option", {
          value: "",
          children: "(Optional) Link to device"
        }), devices.map(d => /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsxs)("option", {
          value: d.id,
          children: [d.name, " (", d.codename, ")"]
        }, d.id))]
      }), /*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx("input", {
        value: name,
        onChange: e => setName(e.target.value),
        placeholder: "Name Roms"
      }), /*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx("input", {
        value: version,
        ...
        value: changelogs,
        onChange: e => setChangelogs(e.target.value),
      ...
      children: items.map(r => /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsxs)("div", {
        style: {
          padding: 12,
          border: "1px solid #eee",
          borderRadius: 12,
...
/* harmony import */ var next_dist_compiled_react_server_dom_webpack_server_edge__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(4491);
    ...
    const tree = {
        ...
        {
        children: ['', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 3367)), "/data/data/com.termux/files/home/cavo/src/app/admin/roms/page.tsx"],
    ...
    const pages = ["/data/data/com.termux/files/home/cavo/src/app/admin/roms/page.tsx"];
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 6721))
...
/* harmony export */ });
/* harmony import */ var _view__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(9137);
...
module.exports = createProxy("/data/data/com.termux/files/home/cavo/src/app/admin/roms/view.tsx");
...
var __webpack_exports__ = __webpack_require__.X(0, [435,22], () => (__webpack_exec__(3438)));
